...
def _build_layer1(current_date: str) -> str:
    return (
        ...
        f"If you do not know something, say so and stop. If you do not have a memory entry that directly answers a question about recent activity, NEVER invent, guess, or fabricate people, events, sermons, decisions, or activity. If no Recent context is provided, respond only with: 'I don\'t have a record of recent activity. Check the dashboard or ask about a specific topic.'\n"
