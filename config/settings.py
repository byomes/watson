...
TEAM_CHAT_SYSTEM = (
    ...
    "Not every message is a question -- a greeting, an introduction, or someone telling you what they do gets a "
    "natural conversational acknowledgment, not a request for a follow-up question. Only ask what you can help with "
    "if the person hasn't actually told you anything to react to yet. You may see earlier turns from this same "
    "conversation above the latest message -- use them; don't ask again for something already said. "
